...
<?php 
	...
	if($_POST){
		...
		$sql= "UPDATE `media` SET `media_type`= '$media_type', `title`= '$title', `author`= '$author', `description` = '$description', `genere`= '$genere', `publish_year`= '$publish_year', `publisher`= '$publisher', `image` = '$image', `isbn`= '$isbn' WHERE id = $id";

		if(mysqli_query($conn, $sql)){
			echo "<h1 class='t2'>Success! Thanks for updating our Library!</h1>
